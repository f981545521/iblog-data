...
public class GenerateSql {
    public static void main(String[] args) throws Exception{
        ...
        for (int i = 0; i < 20000; i++) {
            ...
            String idNo = "";
            do {
                idNo = RandomUtil.getIdNo(sex.equals("男"));
            } while (idNo.length() != 18);

            if (i%5000==0){
                year ++;
            }
            String yearData = year + "-" + String.format("%02d", RandomUtil.nextInt(12)) + "-" + String.format("%02d", RandomUtil.nextInt(28)) + " 00:00:00";
            ...
            String sql = "INSERT INTO `e_user` (`ID`, `IS_DELETE`, `CREATE_TIME`, `UPDATE_TIME`, `PASSWORD`, `STUDENT_NAME`, `SEX`, `CARD_CODE`, `ONE_CARD`, " +
                    ...
                    "', '"+RandomUtil.getTelephone()+"', '2019-06-12 00:00:00', '南京', '211@qq.com', '汉族', 'http://192.168.1.188:8585/images/2019-06/1560492295352_121.png'," +
