...
import cn.acyou.iblogdata.utils.pay.WXPayConstants.SignType;
...
public class WXPayUtil {
    ...
    /**
     * 处理state 参数
     * @param state "packageId-123+dfsf-3fds+"
     * @return map
     */
    public static Map<String, String> produceStateParam(String state){
     ...
     * @return 单位/分
     */
    public static String convertWxFee(Double fee){
        Double feeTemp = fee * 100d;
        return String.valueOf(feeTemp.intValue());
    }
