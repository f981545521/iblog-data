 ...
 **/
@Component
public class LifeBean implements
        BeanNameAware,
        BeanFactoryAware,
        ...
        DisposableBean {
    private String name;
    private cn.acyou.iblog.model.test.LifeBean lb;

    public cn.acyou.iblog.model.test.LifeBean getLb() {
        return lb;
    }

    public void setLb(cn.acyou.iblog.model.test.LifeBean lb) {
        this.lb = lb;
    }
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        this.name = "小三";
        this.lb = new cn.acyou.iblog.model.test.LifeBean();
    }
